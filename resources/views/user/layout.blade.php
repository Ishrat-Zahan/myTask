...
<body>
    ...
    <!-- <script>
        function updateFormFields(fields, categoryId) {
            let formHtml = '';
        ...
        <div class="container py-5 h-100">
            ...
            <form action="{{ route('sscforms.store') }}" method="post" enctype="multipart/form-data" id="myForm">
                                @csrf     
        ...
        $(document).ready(function() {
            $("#category_id").change(function() {
                ...
                if (id == "1") {
                    $('#form-container').html(function(fields) {
                    updateFormFields(fields, id);
                });
                    return;
                }else
                if (id == "2") {
