...
<div class="d-flex justify-content-between m-3">
  <h3 class="text-success">Manage SSC Form</h3>
  <a href="{{route('sscforms.create')}}" class="btn btn-outline-success"> + </a>
</div>
...
<table class="table table-success">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a class="btn btn-success" href="{{route('sscforms.edit',$row->id)}}"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a>

        <form class="d-inline" onsubmit="return confirm('Are you sure?')" action="{{route('sscforms.destroy',$row->id)}}" method="post">
          @csrf
          @method('delete')
