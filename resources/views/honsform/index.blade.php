...
<div class="d-flex justify-content-between m-3">
  <h3 class="text-success">Manage Hon's Form</h3>
  <a href="{{route('honsforms.create')}}" class="btn btn-outline-success"> + </a>
</div>
...
<table class="table table-success">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a class="btn btn-success" href="{{route('honsforms.edit',$row->id)}}"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a>

        <form class="d-inline" onsubmit="return confirm('Are you sure?')" action="{{route('honsforms.destroy',$row->id)}}" method="post">
          @csrf
          @method('delete')
