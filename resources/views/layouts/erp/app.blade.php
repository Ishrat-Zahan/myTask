    ...
    <nav class="sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
        ...
        <ul id="sidebar_menu">
            <li class="mm-active">
                ...
                <ul>
                    <li><a class="active" href="{{route('organization.index')}}">Manage Organization</a></li>
            ...
            <li class="mm-active">
                ...
                <ul>
                    <li><a class="active" href="">Manage Customer</a></li>
            ...
            <li class="mm-active">
                ...
                <ul>
                    <li><a class="active" href="{{route('sscforms.index')}}">Manage SSC Form</a></li>
            ...
            <li class="mm-active">
                ...
                <ul>
                    <li><a class="active" href="{{route('hscforms.index')}}">Manage HSC Form</a></li>
            ...
            <li class="mm-active">
                <a class="has-arrow" href="#" aria-expanded="false">
                    ...
                    <span>Hon's Form</span>
                </a>
                <ul>
                    <li><a class="active" href="{{route('honsforms.index')}}">Manage Hon's Form</a></li>
                    ...
                    <div class="header_iner d-flex justify-content-between align-items-center">
                        ...
                        <div class="header_right d-flex justify-content-between align-items-center">
                            ...
                            <div class="profile_info">
                                <img src="{{ asset('assets/img/wp.png') }}" alt="#">
...
<!-- Mirrored from demo.dashboardpack.com/sales-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Apr 2023 14:25:03 GMT -->
